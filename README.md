...
Abra o SEPATools e cole no campo de texto, o texto copiado da pagina gerada pelo ASIWEB, em seguida escolha no Menu Padronizar - Relação de bens, e o tipo de filtro, para uso em levantamento, utilizar o filtro "Matérial + Patrimônio":
